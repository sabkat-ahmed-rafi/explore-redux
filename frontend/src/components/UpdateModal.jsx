...
import { useUpdateDataMutation } from '../apiSlices/apiSlice';

const UpdateModal = ({modalRef, dataId}) => {
    ...
    const handleUpdate = async (e) => {
        ...
        const updatedData = {email, password, repeatPassword, phone, company, firstName, lastName};
        console.log(updatedData);
        try{
            const result = await updateData({id:dataId, updatedData}).unwrap()
